...
type Parser struct {
	l      *lexer.Lexer // 字句解析インスタンスへのポイント
	errors []string     // エラー情報
...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerInfix(token.LPAREN, p.pasreCallExpression)
...
func (p *Parser) parseIndexExpression(left ast.Expression) ast.Expression {
	...
	p.nextToken()
	exp.Index = p.parseExpression(LOWST)
...
func (p *Parser) parseExpressionList(end token.TokenType) []ast.Expression {
	...
	p.nextToken()
	list = append(list, p.parseExpression(LOWST))
...
func (p *Parser) pasreCallExpression(function ast.Expression) ast.Expression {
...
// 	p.nextToken()
// 	args = append(args, p.parseExpression(LOWST))
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	stmt.Value = p.parseExpression(LOWST)
...
func (p *Parser) parseReturnStatement() *ast.ReturnStatement {
	...
	stmt.ReturnValue = p.parseExpression(LOWST)
...
func (p *Parser) parseExpressionStatement() *ast.ExpressionStatement {
	...
	stmt.Expression = p.parseExpression(LOWST)
